...
namespace WPF.Translations
{
    ...
    public interface ITranslationProvider<T> : IDisposable
    {
        ...
        bool AddResourceForTranslation(string culture, T resourceDictionary, bool loadTranslation);
        ...
        /// <exception cref="ArgumentException">ResourceDictionary does not match KeyContract: missing keys.</exception>
        /// <exception cref="ArgumentException">ResourceDictionary does not match KeyContract: extra keys.</exception>
        void AddResourcesForTranslation(IEnumerable<Tuple<string, T>> translations, bool loadTranslation);
